...
Yaml_File = "/root/Migration-as-a-Service/ansible/config_files/infrastructure/" + arg[1]
Migration_File = "/root/Migration-as-a-Service/ansible/config_files/migration/" + arg[2]
#print(Yaml_File)
